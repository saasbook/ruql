class XMLRenderer
  ...
  def render_fill_in(question)
    @b.question :type => 'GS_Short_Answer_Question_Simple', :id => question.object_id.to_s(16) , :uid => question.uid.to_s do
      @b.metadata {
        @b.parameters {
      ...
      @b.data {
        @b.uid { @b.cdata!(question.uid.to_s) }
  ...
  def render_multiple_choice(question)
    @b.question :type => 'GS_Choice_Answer_Question', :id => question.object_id.to_s(16), :uid => question.uid.to_s do
      @b.metadata {
        @b.parameters {
          @b.rescale_score question.points
      ...
      @b.data {
        @b.uid { @b.cdata!(question.uid.to_s) }
        @b.text { @b.cdata!(question.question_text) }
        @b.option_groups(:randomize => !!question.randomize, :question_uid => question.uid.to_s) {
